...
Introduction
This zip file contains Python scripts for performing music genre classification using Convolutional Neural Networks (CNN) and Convolutional Recurrent Neural Networks (CRNN). The classification is based on Mel-frequency cepstral coefficients (MFCCs) extracted from audio files.
...
Link of the dataset : https://www.kaggle.com/datasets/carlthome/gtzan-genre-collection


Instructions
1. Use Kaggle Notebook to run the scripts.
2. The GTZAN Genre Collection dataset is already available on Kaggle as provided above. Dataset need not be downloaded separately.
